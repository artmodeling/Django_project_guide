...
4. На сайте в созданной форме для добавления товара, проверить, что эта форма работает. То есть, добавить через нее один или несколько новых товаров:
    1) К URL адресу 127.0.0.1:8000 добавить «`/products/add/`», должна открыться страница с формой для добавления товара.    
    2) Заоплнить форму, добавить товар.  
...
5. (Опционально.) Создать коммит: «feat(products): Добавил функционал для добавления поста (самый простой вариант)».
